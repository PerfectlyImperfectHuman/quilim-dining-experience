...
export function Footer() {
  return (
    <footer className="bg-[oklch(0.22_0.04_25)] text-[oklch(0.96_0.01_80)] mt-20">
      <div className="container mx-auto px-4 lg:px-8 py-16 grid gap-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="text-sm text-white/70 leading-relaxed">
            Fine Dining in the Heart of <span className="text-gold">Faisalabad</span> — Pakistani ·
            Continental · Chinese.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/75">
            <li className="flex gap-3">
              <MapPin className="h-4 w-4 text-gold shrink-0 mt-0.5" /> C457+47J Hashmat Ali, Khan
              Rd, Block C People's Colony No 1, Faisalabad
            </li>
            <li className="flex gap-3">
              <Phone className="h-4 w-4 text-gold shrink-0 mt-0.5" />{" "}
              <a href="tel:+924118540373" className="hover:text-gold transition-colors">
                +92 41 8540373
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/75">
            <li className="flex gap-3">
              <Clock className="h-4 w-4 text-gold shrink-0 mt-0.5" /> Monday – Sunday
            </li>
      ...
      <div className="border-t border-white/10 py-5 text-center text-xs text-white/50">
        © 2026 Quilim Restaurant. All Rights Reserved.
      </div>
    </footer>
  );
}
