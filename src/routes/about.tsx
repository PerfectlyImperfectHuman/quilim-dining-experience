...
const values = [
  {
    ...
    desc: "Sourced fresh daily for unmatched flavor.",
  },
...
const milestones = [
  {
    year: "Founded",
    title: "Quilim Opens",
    desc: "Born from a passion for hospitality in Faisalabad.",
  },
  {
    year: "Year 2",
    title: "First Signature Dish",
    desc: "Parmesan Chicken becomes a guest favourite.",
  },
  {
    year: "Year 4",
    title: "Private Dining Added",
    desc: "Banquet halls launched for celebrations.",
  },
  { year: "Year 8", title: "4,000+ Guests Served", desc: "A milestone of trust and loyalty." },
  {
    year: "Today",
    title: "4.6 ★ on Google",
    desc: "Faisalabad's most reviewed fine-dining restaurant.",
  },
];
    ...
    <Layout>
      ...
      <section className="container mx-auto px-4 lg:px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <img
            src={interiorImg}
            alt="Warm candlelit interior at Quilim Faisalabad"
            loading="lazy"
          ...
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-primary font-bold mt-3">
              A Faisalabad Landmark
            </h2>
            ...
            <p className="text-muted-foreground leading-relaxed text-lg mt-4">
              From sizzling karahis to delicate continental classics, every dish is prepared with
              intention — and served in a setting that turns ordinary meals into memories.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 lg:px-8 py-20">
        <div className="text-center mb-14">
          ...
          <h2 className="font-serif text-4xl text-primary font-bold mt-3">
            A Decade of Memorable Meals
          </h2>
          ...
          <div className="grid grid-cols-5 gap-4 relative">
            {milestones.map((m) => (
              <div key={m.year} className="text-center">
                ...
                <div className="mt-5 text-xs uppercase tracking-widest text-gold font-semibold">
                  {m.year}
                </div>
